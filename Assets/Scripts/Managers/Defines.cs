...
namespace PDR
{
    ...
    public static class SubEventType
    {
        ...
        public const int PAWN_PLAY_ANIMATION = 209; // 播放动画
        public const int PAWN_PLAY_ANIMATION_FINISH = 210; // 播放动画结束
        public const int CHECK_DAMAGE = 211; // 结算伤害

        public const int MONSTER_TURN_START = 212;
        public const int MONSTER_TURN_FINISH = 213;

        public const int PLAYER_ATTACK_FINISH = 214;
